...
export default function ProfessionalsRoles() {
    ...
    return (
        <section aria-label="seção de equipe multiprofissional" className="px-6 py-24 pt-0 font-sans">
            <div className="mx-auto max-w-6xl">
                <div className="text-left mb-12">
                    ...
                    <div aria-label="filtro por especialidade" className="bg-white border border-[color-mix(in_srgb,var(--cor-bg-3),black_30%)] p-6 rounded-2xl shadow-sm" tabIndex={0}>
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            return (
                                ...
                                >
                                    <button
                                        onClick={() => setOpenProf(isOpen ? null : prof.professional)}
                                        className="w-full text-left px-6 py-5 flex items-center justify-between select-none focus:ring-2 focus:ring-[var(--cor-bg-3)] outline-none"
                                        // Atributos de Acessibilidade
                                        aria-expanded={isOpen}
                                        aria-label={`Profissional: ${prof.professional}`}
                                    >
                                        <span className={`font-bold transition-colors ${isOpen ? "text-[var(--cor-bg-3)]" : "text-slate-800"}`} aria-hidden="true">
                                            <span className="inline-block w-2.5 h-2.5 rounded-full mr-3 bg-[var(--cor-bg-3)]/50" aria-hidden="true"/>
                                            {prof.professional}
                                        </span>
                                        <ChevronDown
