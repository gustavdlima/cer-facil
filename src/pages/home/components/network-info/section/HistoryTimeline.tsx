...
export default function HistoryTimeline() {
  ...
  return (
    <section id="history-rcpd" className="px-6 py-20 bg-gradient-to-b from-blue-50/30 to-white relative">
      <div className="max-w-6xl mx-auto">
        <div className="text-left mb-16">
          ...
          <p className="text-gray-600 mt-4 max-w-2xl">Uma jornada de evolução e compromisso com os direitos das pessoas com deficiência</p>
        </div>

        <div className="relative">
          <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-200 via-blue-400 to-blue-200" />
              ...
              {index % 2 === 0 && (
                <>
                  <div className="w-5/12 pr-8">
                    <div 
                      className="bg-white p-6 rounded-xl shadow-lg border-2 border-blue-100 hover:border-blue-300 transition-all cursor-pointer hover:shadow-xl group"
                    ...
                    >
                      ...
                      <span className="text-xs text-blue-600 mt-2 block group-hover:underline">
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2">
                    <div className={`flex items-center justify-center w-14 h-14 ${item.color} rounded-full border-4 border-white shadow-lg z-10 hover:scale-110 transition-transform`}>
