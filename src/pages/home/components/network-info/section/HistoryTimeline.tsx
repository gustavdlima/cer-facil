                ...
                <div className="flex-1">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      <Calendar className="w-8 h-8 text-[var(--cor-bg-3)]" />
                      <h3 className="text-2xl font-bold text-[var(--cor-bg-3)]">
                        {item.title}
                      </h3>
                    </div>
                    ...
                    <span className="text-lg text-[var(--cor-bg-3)] font-bold mt-2 block group-hover:underline hover:scale-105 transition-transform inline-block">
                ...
                {index % 2 === 0 && (
                  <>
                    <div className="w-5/12 pr-8">
                      ...
                      >
                        <div className="flex items-center gap-3 mb-3">
                          <Calendar className="w-10 h-10 text-[var(--cor-bg-3)]" />
                          <h3 className="text-2xl font-bold text-[var(--cor-bg-3)]">
                            {item.title}
                          </h3>
                        </div>
