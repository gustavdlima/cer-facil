...
export default function Rodape() {
  ...
  return (
    <div>
      <footer className="px-6 py-12 relative">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-2">
                <div className="flex items-center gap-2">
                  {socialButtons.map((button) => {
                    ...
                    const classes =
                      "flex h-8 w-8 items-center justify-center rounded-full bg-blue-50 text-[var(--cor-1)] transition-colors hover:bg-[var(--cor-1)] hover:text-white";
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                ...
                >
                  <Info className="text-[var(--cor-3)] w-6 h-6" />O que é o
                  PET-Saúde Digital
                </h2>
                <button
                  type="button"
              ...
              <div className="overflow-y-auto pr-2 space-y-6 flex-1 text-justify">
                <p className="text-sm leading-relaxed text-gray-600">
                  ...
                  estabelecidos 12 GTs, que atuam como as unidades executoras
                  das atividades de ensino, pesquisa e extensão. Cada GT é
                  composto por uma equipe multiprofissional e interdisciplinar,
                  reunindo tutores (docentes), preceptores (profissionais do
                  serviço) e monitores (estudantes de graduação). Esta
                  composição visa garantir que o aprendizado ocorra de forma
                  situada, partindo dos problemas reais enfrentados pelos
                  serviços de saúde digital no estado.
                </p>
